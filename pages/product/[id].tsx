...
const Product: NextPage<{ product: Product }> = ({product}) => {
  ...
  return (
    <div className="w-full h-screen overflow-hidden font-nunito laptop:flex laptop:items-center">
      <div className="h-1/2  bg-white laptop:h-full laptop:w-[60%] laptop:flex laptop:justify-center laptop:items-center">
        ...
        {orderSubmitted ? (
          <div className="flex flex-col items-center justify-center w-full h-full bg-veryDarkBlue laptop:w-5/6 laptop:h-5/6 laptop:rounded-2xl">
          ...
          <img
            ...
            alt={product.title}
            className="object-cover object-center w-full h-full laptop:w-5/6 laptop:h-5/6 laptop:rounded-2xl "
          />
        )}
      </div>
      <div className="w-full h-fit rounded-t-2xl  absolute top-[45%] bg-white overflow-hidden laptop:relative laptop:rounded-2xl  laptop:h-5/6 laptop:w-1/3 laptop:top-0 laptop:border-veryDarkBlue/[50%] laptop:border-[1px]">
        <div className="flex flex-col h-full p-8 overflow-hidden justify-evenly">
          ...
          <p className="w-[95%] text-sm py-2">{product.description}</p>
          <div className="flex flex-row flex-wrap items-center w-full py-5 text-sm text-white gap-x-5 smallPhone:justify-between">
            <div className="flex px-3 py-1 my-2 smallPhone:w-auto bg-veryDarkBlue rounded-3xl">
            ...
            <div className="flex items-center px-3 py-1 my-2 smallPhone:w-auto bg-veryDarkBlue rounded-3xl ">
          ...
          <div className="relative flex items-center justify-between pb-5">
            <p className="mr-2 font-bold whitespace-nowrap">Boka produkt</p>
