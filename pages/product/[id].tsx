    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content={`Annonssida för ${product.title}`}
                />
            </Head>
            ...
            <div className="w-full min-[800px]:h-screen overflow-hidden font-nunito min-[800px]:flex min-[800px]:items-center min-[800px]:mt-[92px]">
                <div className=" bg-white max-[800px]:h-[50vh] min-[800px]:h-full min-[800px]:w-[60%] min-[800px]:flex min-[800px]:justify-center min-[800px]:items-center">
                    {orderSubmitted ? (
                        <div className="flex flex-col items-center justify-center w-full h-full bg-veryDarkBlue min-[800px]:w-5/6 min-[800px]:h-5/6 min-[800px]:rounded-2xl">
                            ...
                            <p className="w-1/2 py-2 text-sm text-center text-white">
                                Vi meddelar dig så fort annonsören svarat. Du
                                ser alla meddelanden under dina notiser
                            </p>
                            <button
                                onClick={() => router.push("/")}
                                className="w-1/2 mt-10 bg-transparent border-2 rounded-full btn border-softRed"
                            >
                                TILLBAKA HEM
                            </button>
                        </div>
