...
const Footer = () => {
  return (
    <div className="relative flex lg:flex-col justify-center h-[1300px] lg:h-[700px]">
      <Image src={BackgroundImg} alt="train and mountain" className="absolute top-0 left-0 object-cover object-top h-[100%]" />
      <div className='absolute w-screen max-w-[1234px] top-[56%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-10 flex flex-col gap-[4rem] px-[2rem] md:px-[4rem]'>
        ...
        <div className='flex justify-between flex-col gap-[3rem] lg:flex-row'>
              ...
              <Fragment key={index}>
                <div className='flex flex-col gap-1'>
                  ...
                  <ul className='flex flex-col'>
                    {link.links.map((deepLink, deepIndex) => (
                      <Link
          ...
          <div className='flex flex-col text-white'>
            ...
            <label>
              <input type="text" placeholder='John@Example.com' className='bg-transparent border-b-[1px] w-[15rem] text-lg text-light focus:outline-none' />
              <button type='button' className='border-b-[1px] text-lg'>Anmäl</button>
            </label>
          </div>
        </div>
